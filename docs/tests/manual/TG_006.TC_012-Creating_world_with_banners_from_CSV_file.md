# Verify that the program successfully create a minecraft world with all types of banner blocks from the csv file
...
### Steps
1. From "CodeMetropolis/docs/tests/manual/Test Files" copy "worldBanner" folder to CodeMetropolis/sources folder.
2. Run testGenerateBannerBlocks method from [[TestAllBlockTypesPlacement.java]]
3. Copy the received 'worldBanner' folder to your Minecraft saves folder.
