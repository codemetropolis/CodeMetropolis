# See if the mapping tool converts the TG_005.TC_008-Converter result xml successfully.
...
1.  Run
	```cmd
	java -jar mapping-1.5.0.jar -i Converter.Test8Result.xml -m sourcemeter_mapping_example_3_0.xml
	```
