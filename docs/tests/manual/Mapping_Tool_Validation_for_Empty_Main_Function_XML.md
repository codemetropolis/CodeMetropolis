# See if the mapping tool converts the TG_005.TC_002-Converter expected result xml successfully.
...
1.  Run
	```cmd
	java -jar mapping-1.5.0.jar -i Converter.Test2Result.xml -m sourcemeter_mapping_example_3_0.xml
	```
