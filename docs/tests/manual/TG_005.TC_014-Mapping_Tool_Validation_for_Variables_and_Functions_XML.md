# See if the mapping tool converts the TG_005.TC_006-Converter expected result xml successfully.
...
1.  Run
	```cmd
	java -jar mapping-1.5.0.jar -i Converter.Test6Result.xml -m sourcemeter_mapping_example_2_0.xml
	```
