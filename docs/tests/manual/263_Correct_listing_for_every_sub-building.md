# Test Command Correct Working Mode for Existing Sub-Buildings
...
### Purpose
To verify that the command correctly lists all sub-buildings' names within the current building when such sub-buildings exist.
...
### Expected Result
The Minecraft chat displays all known sub-buildings' names of the current building.
