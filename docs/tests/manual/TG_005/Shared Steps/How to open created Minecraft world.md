...
**Steps:**
1. Find the Minecraft world created by CodeMetropolis's **rendering-1.4.0.jar** file. It is usually in the `CodeMetropolis\sources` folder under the default name **world** if it hasn't been changed otherwise.
...
6. Open Minecraft 1.8 and choose Singleplayer. Here you should find an existing world.
