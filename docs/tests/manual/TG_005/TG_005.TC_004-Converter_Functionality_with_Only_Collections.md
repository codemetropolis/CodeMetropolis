...
- [[TG_005/Test Files/Converter.Test4.graph]]
...
1.  Run
	```cmd
	java -jar converter-1.4.0.jar -t sourcemeter -s Converter.Test4.graph
	```
	in converter-1.4.0.jar command line
2. Compare the resulting file with the [[TG_005/Expected Results/Converter.Test4Result.xml]] file

### Expected Result
The [[TG_005/Expected Results/Converter.Test4Result.xml]] file and the generated file match.