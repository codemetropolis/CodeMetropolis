...
1. Run
	```cmd
	java -jar mapping-1.4.0.jar -i Mapping.TestX.xml -m sourcemeter_mapping_example_2_0.xml -s 100
	```
	in mapping-1.4.0.jar command line
2. Compare the resulting file with the [[TG_005/Expected Results/Mapping.Test13Result.xml]] file

### Expected Result
The [[TG_005/Expected Results/Mapping.Test13Result.xml]] file and the generated file match expect for the buildable ids as they vary.