**Compilable test**
# [Test] Check if project is compilable on issue branch
...
3. Type `git clone https://github.com/codemetropolis/CodeMetropolis.git` into the command line
4. Navigate to the CodeMetropolis\sources folder and open a git bash command line the same as before
5. Run `mvn clean package` in the command line
