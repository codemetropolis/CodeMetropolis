...
2. Navigate to the directory containing the tool and the prepared IXML file.
...
```cmd
java -jar ixmlexclude.jar -i specialChars.ixml -o output.ixml --exclude-property-name ".*[Special]^$" --exclude-property-value "[Characters]*?"
```
