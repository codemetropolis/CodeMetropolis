...
- [[TG_005/Expected Results/Mapping.Test5Result.xml]]
...
1. Run
	```cmd
	java -jar placing-1.4.0.jar -i Mapping.Test5Result.xml
	```
	in placing-1.4.0.jar command line
2. Compare the resulting file with the [[TG_005/Expected Results/Placing.Test5Result.xml]] file

### Expected Result
The [[TG_005/Expected Results/Placing.Test5Result.xml]] file and the generated file match expect for the buildable ids as they vary.