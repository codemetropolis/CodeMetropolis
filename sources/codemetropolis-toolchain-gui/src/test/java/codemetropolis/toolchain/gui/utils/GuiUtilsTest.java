...
public class GuiUtilsTest {
	...
	/**
	 * Test automatic find of minecraft folder. The null is also valid return value, but we cannot build
	 * test enviroment so we accept both cases: when the return is null or when its not null and then it's
	 * a valid directory.
	 */
	@Test	
