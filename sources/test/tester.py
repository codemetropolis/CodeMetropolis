...
parser.add_argument('--override', dest='gen_output_path', type=str,
...
argGeneratedOutputPath = arguments.gen_output_path
...
def warning(argPytestFolder, argPytestFile, argInput, argExpectedoutput, argGeneratedOutputPath):
    ...
    if (path.exists(argPytestFolder) == False):
        print("Warning: Nincs ilyen nevű mappa vagy hibás az elérési útvonal!")
        return -1
...
"""
def noPytestFileWarning():
    return print("Nem található pytest szabályoknak megfelelő test fájl!")
"""
...
def converterJar(argInput, generatedOutputPath):
        ...
        #shutil.move('converterToMapping.xml', '' + generatedOutputPath)
