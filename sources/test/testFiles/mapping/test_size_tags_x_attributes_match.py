...
def test_size_tags_x_attributes_match(expected_xml, mapping_output_xml):
    result_expected = extract_tags_and_attributes_nested(expected_xml, BUILDABLE, NONE, SIZE, X)
    result_output = extract_tags_and_attributes_nested(mapping_output_xml, BUILDABLE, NONE, SIZE, X)
