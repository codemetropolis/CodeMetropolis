...
def test_attribute_tags_name_attributes_match(expected_xml, mapping_output_xml):
    result_expected = extract_tags_and_attributes_nested(expected_xml, BUILDABLE, ATTRIBUTES, ATTRIBUTE, NAME)
    result_output = extract_tags_and_attributes_nested(mapping_output_xml, BUILDABLE, ATTRIBUTES, ATTRIBUTE, NAME)
