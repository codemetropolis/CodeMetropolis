...
def test_attribute_tags_value_attributes_match(expected_xml, placing_output_xml):
    result_expected = extract_tags_and_attributes_nested(expected_xml, BUILDABLE, ATTRIBUTES, ATTRIBUTE, VALUE)
    result_output = extract_tags_and_attributes_nested(placing_output_xml, BUILDABLE, ATTRIBUTES, ATTRIBUTE, VALUE)
