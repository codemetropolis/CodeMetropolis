...
def testPositionElements_YAttributes(expected, output):
    ...
    try:
        ...
        assert expectedListLength == passCounter, f"test_PositionElements_YAttributes: The value of the position element Y attribute is '{errorY}' in the output file, but it should be '{correctY}' based on the expected file."
