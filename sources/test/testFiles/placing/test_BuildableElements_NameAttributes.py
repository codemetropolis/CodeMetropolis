...
def testBuildableElements_NameAttributes(expected, output):
    ...
    try:
        ...
        assert expectedListLength == passCounter, f"test_BuildableElements_NameAttributes: The value of the buildable element name attribute is '{errorName}' in the output file, but it should be '{correctName}' based on the expected file."
