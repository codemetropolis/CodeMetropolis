...
def test_position_tags_z_attributes_match(expected_xml, placing_output_xml):
    result_expected = extract_tags_and_attributes_nested(expected_xml, BUILDABLE, NONE, POSITION, Z)
    result_output = extract_tags_and_attributes_nested(placing_output_xml, BUILDABLE, NONE, POSITION, Z)
