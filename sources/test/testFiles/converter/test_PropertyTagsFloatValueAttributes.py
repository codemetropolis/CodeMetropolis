...
def testPropertyTagsFloatValueAttributes(expected, output):
    ...
    try:
        ...
        pytest.fail("Mismatched float values. One value is " + str(errorValue) + " but the correct value should be " + str(correctValue) + ".")      
