...
import codemetropolis.toolchain.converter.gitstat.GitStatHTMLParser;
...
class GitStatHTMLParserTest {
	...
	void testGetPropertiesFromHTMLFiles() {
		...
		props = GitStatHTMLParser.getPropertiesFromHTMLFiles(".\\src\\main\\java\\codemetropolis\\toolchain\\converter\\gitstat\\tests\\test_resource\\TestHTMLParser");
	...
	void testGetLinesFromHTMLFiles() {		
		...
		List<String> result = GitStatHTMLParser.getLinesFromHTMLFiles(".\\src\\main\\java\\codemetropolis\\toolchain\\converter\\gitstat\\tests\\test_resource\\TestHTMLParser");
